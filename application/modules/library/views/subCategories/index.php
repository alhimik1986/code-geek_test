...
/*
	...
	@var $model SubCategories (Model)   - Модель (для отображения подписей аттрибутов)
*/
?>
...
<table id="urv-table" class="urv-table" style="width:100%">
	<thead>
		<tr>
			...
			<th style="width:300px" column_name="<?php echo $model::table(); ?>.category_id"><?php echo $model->getAttributeLabel('category_id'); ?></th>
			<th                     column_name="<?php echo $model::table(); ?>.name"><?php echo $model->getAttributeLabel('name'); ?></th>
		</tr>
