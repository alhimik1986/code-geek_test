...
class URV_ModelCode extends CCodeModel
{
	...
	public $generateOverridableMethods=true; // Генерировать переопределяемые методы для более гибкой настойки модели
	...
	public function rules()
	{
		return array_merge(parent::rules(), array(
			...
			array('connectionId, tablePrefix, modelPath, baseClass, buildRelations, commentsAsLabels, generateOverridableMethods', 'sticky'),
		));
	}
	...
	public function attributeLabels()
	{
		return array_merge(parent::attributeLabels(), array(
			...
			'modelPath'=>'Путь',
			'modelClass'=>'Класс',
			'baseClass'=>'Наследуемый класс',
			'buildRelations'=>'Построить Relations (отношения таблиц)',
			'commentsAsLabels'=>'Использовать комментарии колонок таблицы в качестве подписей аттрибутов',
			'generateOverridableMethods'=>'Генерировать переопределяемые методы для более гибкой настойки модели',
			'connectionId'=>'Компонент подключения к базе данных',
		));
	}
