<?php $pageTitle = Yii::t('app', 'Page Not Found'); ?>
...
<div class="format">
	...
	<p>
		<?php echo Yii::t('app', 'The requested URL was not found on this server. If you entered the URL manually please check your spelling and try again.'); ?>
	</p>
	<p>
